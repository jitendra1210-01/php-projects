...
<body>
    ...
    <div class="container">
        ...
        ?>
            <div class="table-header button-content">
                <div>

                    <a href="add.php" class="add-button"><i class="bi bi-plus-lg"></i> Add New Data</a>
                    <a href="show.php" class="show-button"><i class="bi bi-eye"></i> Show Data</a>
                </div>
            </div>
